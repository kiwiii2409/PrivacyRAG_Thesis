...
\newcommand*{\getTitle}{Improving and Benchmarking Privacy in RAG}
\newcommand*{\getTitleGer}{Titel der Abschlussarbeit}
\newcommand*{\getAuthor}{Kevin Muyuan Zhou}
...
\newcommand*{\getSubmissionDate}{19.09.2025}
...
\input{chapters/03_literature.tex}
...
\begin{acronym}
	...
	\acro{SAGE}{Synthetic Attribute-based Generation with agEnt-based refinement}
	\acro{MIA}{Membership Inference Attack}
	\acro{CLAM}{Cross-document Linkage-Aware Masking}
